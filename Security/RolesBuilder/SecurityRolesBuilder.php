...
final class SecurityRolesBuilder implements ExpandableRolesBuilderInterface
{
    ...
    private function getSecurityRole(string $role, string $domain = null): array
    {
        return [
            'role' => $role,
    ...
    private function getSecurityRoles(array $hierarchy, array $roles, string $domain = null): array
    {
        $securityRoles = [];
